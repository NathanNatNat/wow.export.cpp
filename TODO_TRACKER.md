...
> **Progress: 11/197 verified (6%)** — ✅ = Verified, ⬜ = Pending
...
- [ ] 639. [MDXRendererGL.cpp] Port upstream MDX renderer changes
...
- [ ] 642. [GLContext.cpp / ShaderProgram.cpp / UniformBuffer.cpp / VertexArray.cpp] Port upstream GL subsystem fixes
...
- [ ] 643. [M2Loader.cpp / M2LegacyLoader.cpp / M3Loader.cpp / SKELLoader.cpp / WMOLoader.cpp / WMOLegacyLoader.cpp] Port upstream loader changes
...
- [ ] 644. [WMOExporter.cpp / WMOLegacyExporter.cpp / OBJWriter.cpp] Port upstream WMO exporter changes
...
- [ ] 645. [M2Exporter.cpp / CharacterExporter.cpp / GLTFWriter.cpp] Port upstream M2/Character exporter and writer changes
...
- [ ] 648. [DB cache files] Port upstream DB cache additions and changes
...
- [ ] 649. [listfile.cpp / dbd-manifest.cpp] Port upstream CASC subsystem fixes
...
- [ ] 650. [core.cpp / file-writer.cpp / generics.cpp] Port upstream core and utility fixes
...
- [ ] 651. [gpu-info.cpp] Port Windows GPU info fix — WMIC replaced with PowerShell CIM
...
- [ ] 652. [data-table.cpp / tab_data.cpp / legacy_tab_data.cpp] Port data table copy/export active-filter fix
...
- [ ] 653. [tab_models.cpp / tab_creatures.cpp / model-viewer-utils.cpp] Port posed OBJ/STL export feature
...
- [ ] 654. [ShaderMapper.cpp / Skin.cpp / GeosetMapper.cpp / Texture.cpp] Port upstream 3D subsystem fixes
...
- [ ] 655. [modules.cpp / mmap.cpp / misc files] Port remaining upstream miscellaneous changes
