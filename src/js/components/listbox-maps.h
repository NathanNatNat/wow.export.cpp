...
/**
 * Listbox-maps component (ImGui immediate-mode equivalent).
 *
 * JS equivalent: Extends the base listbox component with expansion filtering for maps.
 *
 * Additional props:
